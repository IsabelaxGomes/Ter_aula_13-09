...
namespace API_Folha
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            (
                options => options.UseSqlite("DataSource=folhas.db;Cache=shared")//Somente aqui que falo o banco que dados que será utilizado e () passa a string de conexão do DAtaContext.
            );
